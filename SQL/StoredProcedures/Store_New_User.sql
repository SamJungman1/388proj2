...
BEGIN
INSERT INTO user (Email,Username,Password,Tag,Firstname,Lastname,Address,City,Zipcode,State,Country)
VALUES (Email1,Username1,sha2(Password1,512),tag1,First_Name1,Last_Name1,Address1,City1,Zip_Code1,State1,Country1);
END